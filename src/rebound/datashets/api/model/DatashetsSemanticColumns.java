 ...
 */
@Immutable
public class DatashetsSemanticColumns
{
	 ...
	 */
	public DatashetsSemanticColumns(@Nonnull List<String> columnUIDs)
	{
	...
	/**
	 * @param uid case insensitive (auto uppercased)
	 * @throws DatashetsNoSuchColumnException  if not present
	 */
	public int requireIndexByUID(String uid) throws DatashetsNoSuchColumnException
	{
		Integer i = getIndexByUID(uid);
		if (i == null)
			throw new DatashetsNoSuchColumnException(uid);
		else
			return i;
	}
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		DatashetsSemanticColumns other = (DatashetsSemanticColumns) obj;
	...
	public boolean hasSameUIDsIgnoringOrder(DatashetsSemanticColumns other)
	{
		return new HashSet<>(this.getUIDsReadonly()).equals(new HashSet<>(other.getUIDsReadonly()));
	}
	
	public Set<String> getUIDOverlapWith(DatashetsSemanticColumns other)
	{
